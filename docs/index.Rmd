...
To start a new file, copy the template version "bio_data_v2024_SOLEMON_template.accdb", paste it in the same folder and rename it as "bio_data_v2024_SOLEMON_YEAR_N.accdb", where YEAR is the reporting year and N is a progressive number. Example: "**bio_data_v2024_SOLEMON_2024_1.accdb**" . *It does not matter if parts of the same haul are in different files, this is handled in post-processing*.
