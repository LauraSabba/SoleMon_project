...
Specify just how to call and where to store the excels files retrieved from seastar. There will be a file that keep track of the minilog deployment. Name of the minilog data file should be like minilogcode_partx
